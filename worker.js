...
const BOT_TOKEN = "7912521844:AAFO1PJb98V7asqsfg9Fj8TeKxUGomV8awY"; // Insert your bot token.
const BOT_WEBHOOK = "/endpoint"; // Let it be as it is.
const BOT_SECRET = "NADEENxDEV"; // Insert a powerful secret text (only [A-Z, a-z, 0-9, _, -] are allowed).
const BOT_OWNER = 5737807853; // Insert your telegram account id.
const BOT_CHANNEL = -1003243287441; // Insert your telegram channel id which the bot is admin in.
const SIA_SECRET = "NADEEN"; // Insert a powerful secret text and keep it safe.
